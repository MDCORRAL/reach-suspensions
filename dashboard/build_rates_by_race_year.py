...
OUTPUT_PATH = OUTPUT_DIR / "rates_by_race_year.json"
OUTPUT_JS_PATH = OUTPUT_DIR / "rates_by_race_year.js"
...
def main() -> None:
    ...
    js_banner = "// Auto-generated by build_rates_by_race_year.py. Do not edit manually.\n"
    js_assignment = "window.RATES_BY_RACE_YEAR_DATA = " + json.dumps(payload, ensure_ascii=False) + ";\n"
    with OUTPUT_JS_PATH.open("w", encoding="utf-8") as f:
        f.write(js_banner)
        f.write(js_assignment)
