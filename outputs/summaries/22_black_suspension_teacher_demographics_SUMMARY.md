...
- Unduplicated counts rely on student ID matching
...
3. `22_high_suspension_schools_detailed.csv` - Individual school-level detail for all 3,176 high-suspension school-year observations
...
All files located in: `outputs/tables/` and `outputs/graphs/`
...
**Suggested Citation**:
> REACH Suspensions Analysis (2025). "Black Student Suspension Rates by School Racial Composition and Teacher Demographics: Analysis of California Public Schools, 2017-24." UCLA Center for the Transformation of Schools.
...
> Full methodology and code available at: `Analysis/22_black_suspension_rates_teacher_demographics.R`
> Comprehensive guide: `Analysis/22_ANALYSIS_GUIDE.md`
